...
# https://accounts.spotify.com/authorize?client_id=(clientID)&response_type=code&redirect_uri=(URL Encoded Redirect URI)&scope=playlist-modify-public%20playlist-modify-private%20user-read-recently-played
...
playlist_id = '' # Recently played playlist URI (any playlist you make)
